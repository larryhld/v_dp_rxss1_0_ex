...
set psu_mio_init_data {
    ...
    mask_write 0XFF180140 0x03FFFFFF 0x02E7EF1E
    ...
    mask_write 0XFF18014C 0x03FFFFFF 0x01DBFFFF
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x01FDF015
    ...
    mask_write 0XFF180178 0x03FFFFFF 0x02FC0FBF
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF180320 0x33840000 0x02840000
		# : SD1 BASE CLOCK
...
set psu_resetout_init_data {
    ...
    mask_write 0XFD480094 0x00007E00 0x00004A00
