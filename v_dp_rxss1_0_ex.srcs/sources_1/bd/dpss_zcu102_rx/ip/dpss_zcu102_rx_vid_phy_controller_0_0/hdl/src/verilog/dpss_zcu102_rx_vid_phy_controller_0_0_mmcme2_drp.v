...
module dpss_zcu102_rx_vid_phy_controller_0_0_mmcme2_drp
   #(
      //***********************************************************************
      ...
      input  wire [7:0] PROG_CLKFBOUT_MULT,
      input  wire [9:0] PROG_CLKFBOUT_FRAC,
      input  wire [7:0] PROG_DIVCLK_DIVIDE,
      input  wire [7:0] PROG_CLKOUT0_DIVIDE,
      input  wire [9:0] PROG_CLKOUT0_FRAC,
      input  wire [7:0] PROG_CLKOUT1_DIVIDE,
      input  wire [7:0] PROG_CLKOUT2_DIVIDE,
   ...
   // required.
   `include "vid_phy_controller_v2_2_4_mmcme2_drp_func.v"
