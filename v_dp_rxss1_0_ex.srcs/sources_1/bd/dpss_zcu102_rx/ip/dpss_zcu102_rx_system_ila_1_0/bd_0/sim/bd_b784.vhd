...
----------------------------------------------------------------------------------
--Command: generate_target bd_b784.bd
--Design : bd_b784
...
entity bd_b784 is
  ...
  attribute CORE_GENERATION_INFO of bd_b784 : entity is "bd_b784,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_b784,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_b784 : entity is "dpss_zcu102_rx_system_ila_1_0.hwdef";
end bd_b784;

architecture STRUCTURE of bd_b784 is
  component bd_b784_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component bd_b784_ila_lib_0;
  component bd_b784_g_inst_0 is
  port (
    aclk : in STD_LOGIC;
    ...
    m_slot_0_axis_tid : out STD_LOGIC_VECTOR ( 7 downto 0 )
  );
  end component bd_b784_g_inst_0;
  signal Conn_TDATA : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal Conn_TID : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal net_slot_0_axis_tid : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXIS, ASSOCIATED_RESET resetn, CLK_DOMAIN dpss_zcu102_rx_zynq_ultra_ps_e_0_0_pl_clk0, FREQ_HZ 99999001, INSERT_VIP 0, PHASE 0.000";
